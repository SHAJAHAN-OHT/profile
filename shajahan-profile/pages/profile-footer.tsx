...
const navigation = [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/shaik.shajahan.9275',
      icon: (props) => (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/shajahan__shaik/?hl=en',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/Shajahanhng',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    },
    {
      ...
      icon: (props) => (
        <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 30 30" {...props} width="30px" height="30px">    
...
/>
    ...
    {
      name: 'Twitter',
      href: 'https://mobile.twitter.com/Shajahan__Shaik',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
