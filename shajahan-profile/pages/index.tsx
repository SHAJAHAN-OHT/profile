    ...
    <div>
      ...
      <div className='bg-gradient-to-r from-indigo-100 via-purple-300 to-pink-100'>
        ...
        <div className='p-10 flex items-center justify-center z-10'>
          <button
            type="button"
            className="inline-flex items-center px-4 py-3 border border-transparent text-sm font-base rounded-md shadow-sm text-white bg-indigo-400 hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
